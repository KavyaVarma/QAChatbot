#question processing
#Input :question
#Output : Key Value pair of word and its frequency,Raw question,Type of question,Expected answer type
...
class ProcessedQuestion:
    ...
    #[PERSON, LOCATION, DATE, ORGANIZATION, QUANTITY, DEFINITION,FULL]
